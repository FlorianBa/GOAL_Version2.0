...
public class testappforKMLandCSV {
	...
	public static void createReports() {
		...
		GraphViewData data4 = new GraphViewData(2.12, 1.22);
		GraphViewData data5 = new GraphViewData(5.53, 5.34);
		GraphViewData data6 = new GraphViewData(2.27, 2.44);
		GraphViewData data7 = new GraphViewData(78.22, 4.2);
		GraphViewData data8 = new GraphViewData(5.2, 9.9);
		GraphViewData data9 = new GraphViewData(3.22, 3.404);
		GraphViewData data10 = new GraphViewData(44.2, 7.14);
		GraphViewData data11 = new GraphViewData(3.23, 1.2);
		GraphViewData data12 = new GraphViewData(5.27, 1.33);
		listAccX.add(data1);
		listAccX.add(data2);
		listAccX.add(data3);
		listAccX.add(data4);
